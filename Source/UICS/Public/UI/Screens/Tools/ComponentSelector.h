...
struct UICS_API FComponentSelector : public FSelector
{
	GENERATED_BODY()
public:
	FComponentSelector();
...
// holds a component that was selected by the user and can be accessed at runtime
USTRUCT()
struct UICS_API FDataComponentSelector : public FComponentSelector
{
	GENERATED_BODY()
public:
...
// holds a component that was selected by the user and can be accessed at runtime
USTRUCT()
struct UICS_API FViewComponentSelector : public FComponentSelector
{
	GENERATED_BODY()
public:
...
// holds a component that was selected by the user and can be accessed at runtime
USTRUCT()
struct UICS_API FTransactionComponentSelector : public FComponentSelector
{
	GENERATED_BODY()
public:
...
// holds a component that was selected by the user and can be accessed at runtime
USTRUCT()
struct UICS_API FEntryComponentSelector : public FComponentSelector
{
	GENERATED_BODY()
public:
