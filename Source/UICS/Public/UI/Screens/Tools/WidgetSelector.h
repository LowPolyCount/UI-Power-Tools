...
struct UICS_API FWidgetResolver
{
	GENERATED_BODY()
public:
...
USTRUCT(BlueprintType)
struct UICS_API FWidgetSelector : public FSelector
{
	GENERATED_BODY()
public:
...
USTRUCT()
struct UICS_API FPanelWidgetSelector : public FWidgetSelector
{
	GENERATED_BODY()
