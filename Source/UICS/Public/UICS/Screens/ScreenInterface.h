...
UINTERFACE(MinimalAPI, BlueprintType, NotBlueprintable, meta = (DeprecationMessage = "Class is no longer needed and will be removed in v1.1. Replace Close() with RemoveFromParent()"))
 ...
 */
class UICS_API IScreenInterface
{
	GENERATED_BODY()
public:
