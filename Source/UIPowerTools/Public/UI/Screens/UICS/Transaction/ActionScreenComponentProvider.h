...
public:
	...
	// @Entry - Data (usually) from the currently focused/selected widget 
	UFUNCTION(BlueprintNativeEvent, Category = ActionScreenComponent)
	EActionResult ExecuteAction(UActionScreenComponent* Component, UObject* Entry);

protected:
	virtual EActionResult ExecuteAction_Implementation(UActionScreenComponent* Component, UObject* Entry);
